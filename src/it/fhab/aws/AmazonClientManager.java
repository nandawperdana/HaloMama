...
public class AmazonClientManager {
    ...
    public boolean hasCredentials() {
        return (!(Constants.ACCOUNT_ID.equalsIgnoreCase("326820369316")
                || Constants.IDENTITY_POOL_ID.equalsIgnoreCase("us-east-1:d51cfebb-a83f-4d6b-9ad4-b44f2e6340ba")
                || Constants.UNAUTH_ROLE_ARN
                    .equalsIgnoreCase("arn:aws:iam::326820369316:role/Cognito_fhabBackendUnauth_DefaultRole")));
    }
